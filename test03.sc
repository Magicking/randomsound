...
a = Array.fill(2, {Synth("wow", ["freq", rrand(40, 70).midicps, "amp", rrand(0.1, 0.5)])});
(
a = Pbind(
...
cc = MIDIdef.cc('ccTest', {
	...
	(
	switch(ccNum,
		13, {fader0=vel.linlin(0, 127, 60, 240)},
		6, {fader1=vel},
		7, {fader2=vel},
		14, {fader3=vel.linlin(0, 127, 1, 100)}
	);
	);
//    if (fader1 == 0 && fader2 == 0,
//        {fader3=0},
//        {});
	[fader0, fader1, fader2, fader3].postln;
	x.set('freq', fader0);
	x.set('wowrelease', fader3);
//	x.set('gate', fader1);
});
q = { cc.free; };
)
